...
export async function sync(options: SyncOptions): Promise<void> {
  ...
  if (!isClaudeCodeInstalled()) {
    ...
    console.log(chalk.gray('Make sure Claude Code is installed and has been used at least once.\n'));
  ...
  console.log(`  ${chalk.gray('Spent:')}      ${chalk.green('$' + usageData.totalSpent.toFixed(2))}`);
