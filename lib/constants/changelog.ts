...
export const CHANGELOG: readonly ChangelogEntry[] = [
  ...
  {
    id: "2026-09-05-globe-spin",
    date: "2026-09-05",
    category: "fixed",
    title: "The globe no longer snaps back when you open a profile",
    summary: "Clicking a row used to rebuild the globe and reset its rotation.",
  },
  {
