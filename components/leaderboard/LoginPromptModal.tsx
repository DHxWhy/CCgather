          ...
          <div className="p-6 pt-8 text-center">
            ...
            <div className="space-y-2">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-[#24292e] hover:bg-[#2f363d] text-white rounded-lg font-medium transition-colors"
              >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-white hover:bg-gray-100 text-gray-800 rounded-lg font-medium transition-colors"
              >
