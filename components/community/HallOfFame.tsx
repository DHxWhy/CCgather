...
import { Heart, MessageCircle, Trophy, Flame, Crown } from "lucide-react";
...
export interface HallOfFameEntry {
  ...
  userName: string;
  userAvatar?: string;
  count: number; // likes or replies count
}
    ...
    <div className={cn("space-y-4", className)}>
      ...
      <div className="space-y-1">
        ...
        <div className="space-y-0.5">
          ...
          {mostLiked.length === 0 && (
            <p className="text-[10px] text-[var(--color-text-muted)] italic py-2">No posts yet</p>
          )}
        </div>
      </div>
